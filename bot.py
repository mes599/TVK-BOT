...
# Name that appears in verification/rejection messages
        ...
        try:
            ...
            async with lock:
                ...
                try:
                    ...
                    print(
                        f"⚠️ Could not update payment DM: {error}"
                    )

                # -----------------------------------------
                # PUBLIC MESSAGE IN PRIVATE TICKET
                # -----------------------------------------
            ...
            print(
                "❌ Unexpected error in payment rejection:"
            )
        ...
        try:
            ...
            async with lock:
                ...
                try:
                    ...
                    print(
                        f"⚠️ Could not send verification message: "
                        f"{error}"
                    )
            ...
            print(
                "❌ Unexpected error in payment verification:"
            )
