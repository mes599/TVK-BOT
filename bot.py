...
try:
    ...
    if missing_secret:
        print(f"Configuration error: {missing_secret} is not set.")
        BOT_TOKEN = None
    else:
        # Keep the existing startup flow intact while configuration becomes
        # the single source of truth for future modules.
...
class TicketBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        if settings.ai_enabled:
            ...
            await self.add_cog(AIAgentCog(self, settings))
